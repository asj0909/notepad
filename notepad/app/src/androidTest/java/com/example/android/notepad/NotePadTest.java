...
public class NotePadTest {
    ...
    @Test
    public void testAddNote() throws IOException, InterruptedException {
...
//        Screenshot.capture().process();
        ...
        onView(allOf(withClassName(endsWith("EditText")), withId(R.id.note))).perform(click());
        onView(withId(R.id.note)).perform(typeTextIntoFocusedView("Note 1"));
        closeSoftKeyboard();
        pressBack();
        ...
        Thread.sleep(2000);
        onView(allOf(withClassName(endsWith("EditText")), withId(R.id.note))).perform(click());
        onView(withId(R.id.note)).perform(typeTextIntoFocusedView("Note 2"));
        closeSoftKeyboard();
        pressBack();
